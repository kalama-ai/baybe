"""Forrester TL regression benchmark with noise level 0.5 source.
...
def forrester_noise_05_regr(
    ...
    noisy source to clean target function. Tests TL model ability to filter
    noise and improve predictive accuracy over non-TL baselines.
...
# Benchmark instance
forrester_noise_05_regr_benchmark = TransferLearningRegressionBenchmark(
    function=forrester_noise_05_regr,
