"""Forrester TL regression benchmark with noise level 2.0 source.
...
def forrester_noise_2_regr(
    ...
    highly noisy source to clean target. Tests limits of TL model robustness
    and predictive improvements under severe noise conditions.
...
# Benchmark instance
forrester_noise_2_regr_benchmark = TransferLearningRegressionBenchmark(
    function=forrester_noise_2_regr,
