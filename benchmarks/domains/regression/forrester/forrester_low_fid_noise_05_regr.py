"""Forrester TL regression benchmark with low-fidelity source and noise 0.5.
...
def forrester_low_fid_noise_05_regr(
    settings: TransferLearningRegressionBenchmarkSettings,
) -> pd.DataFrame:
    """Forrester TL regression benchmark with low-fidelity function and noise 0.5.

    This benchmark evaluates regression performance when transferring from
    low-fidelity to high-fidelity functions under moderate noise conditions.
...
# Benchmark instance
forrester_low_fid_noise_05_regr_benchmark = TransferLearningRegressionBenchmark(
    function=forrester_low_fid_noise_05_regr,
