"""Forrester TL regression benchmark with low-fidelity source and noise 0.2.
...
• Source: Low-fidelity Forrester (a=0.5, b=10, c=-5) with noise_std=0.2
...
def forrester_low_fid_noise_02_regr(
    settings: TransferLearningRegressionBenchmarkSettings,
) -> pd.DataFrame:
    """Forrester TL regression benchmark with low-fidelity function and noise 0.2.

    This benchmark evaluates regression performance when transferring from
    low-fidelity to high-fidelity functions under light noise conditions.
    Tests TL model ability to transfer from reduced oscillatory component.
    ...
    """
    source_config = {**LOW_FIDELITY_CONFIG, "output_noise": 0.2}
...
# Benchmark instance
forrester_low_fid_noise_02_regr_benchmark = TransferLearningRegressionBenchmark(
    function=forrester_low_fid_noise_02_regr,
