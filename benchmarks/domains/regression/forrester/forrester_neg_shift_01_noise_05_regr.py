"""Forrester TL regression benchmark with negative shift -0.1 and noise 0.5.
...
def forrester_neg_shift_01_noise_05_regr(
...
# Benchmark instance
forrester_neg_shift_01_noise_05_regr_benchmark = TransferLearningRegressionBenchmark(
    function=forrester_neg_shift_01_noise_05_regr,
