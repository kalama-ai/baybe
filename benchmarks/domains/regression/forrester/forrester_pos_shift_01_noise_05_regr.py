"""Forrester TL regression benchmark with positive shift 0.1 and noise 0.5.
...
• Source: Shifted Forrester (x_shift=0.1) with noise_std=0.5
...
def forrester_pos_shift_01_noise_05_regr(
    ...
    right-shifted source to clean target. Tests TL model ability to handle
...
# Benchmark instance
forrester_pos_shift_01_noise_05_regr_benchmark = TransferLearningRegressionBenchmark(
    function=forrester_pos_shift_01_noise_05_regr,
