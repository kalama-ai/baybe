"""Forrester TL regression benchmark with amplified noisy source.
...
def forrester_amplified_noise_05_regr(
    settings: TransferLearningRegressionBenchmarkSettings,
) -> pd.DataFrame:
    """Forrester TL regression benchmark with amplified function and noise 0.5.

    This benchmark evaluates regression performance when transferring from
    parameter-mismatched and noisy source to clean target. Tests TL model
    ability to handle both parameter differences and noise.
...
# Benchmark instance
forrester_amplified_noise_05_regr_benchmark = TransferLearningRegressionBenchmark(
    function=forrester_amplified_noise_05_regr,
