"""Forrester TL regression benchmark with amplified high-noise source.
...
def forrester_amplified_noise_2_regr(
    settings: TransferLearningRegressionBenchmarkSettings,
) -> pd.DataFrame:
    """Forrester TL regression benchmark with amplified function and noise 2.0.

    This benchmark evaluates regression performance under challenging conditions:
    both significant parameter differences and high noise levels. Tests limits
    of TL model robustness for cross-parameter transfer.
...
# Benchmark instance
forrester_amplified_noise_2_regr_benchmark = TransferLearningRegressionBenchmark(
    function=forrester_amplified_noise_2_regr,
