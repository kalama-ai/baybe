"""Forrester transfer learning benchmark with low-fidelity source and noise 0.2.
...
def forrester_low_fid_noise_02(
    settings: ConvergenceBenchmarkSettings,
) -> pd.DataFrame:
    """Forrester TL benchmark with low-fidelity function and noise level 0.2.

    This benchmark evaluates transfer learning from low-fidelity to high-fidelity
    functions under light noise conditions. Tests TL model ability to transfer
    from reduced oscillatory component with strong linear trend.
...
# Benchmark instance
forrester_low_fid_noise_02_benchmark = ConvergenceBenchmark(
    function=forrester_low_fid_noise_02,
