"""Forrester transfer learning benchmark with positive shift 0.15 and noise 0.5.
...
• Source: Right-shifted Forrester (shift=0.15) with noise_std=0.5
...
def forrester_pos_shift_015_noise_05(
    settings: ConvergenceBenchmarkSettings,
) -> pd.DataFrame:
    """Forrester TL benchmark with positive shift 0.15 and noise level 0.5.

    This benchmark evaluates transfer learning from spatially shifted source
    domains in the opposite direction. Tests TL model ability to handle domain
    shift where g(x) = f(x - 0.15), comparing with negative shift scenarios.
...
# Benchmark instance
forrester_pos_shift_015_noise_05_benchmark = ConvergenceBenchmark(
    function=forrester_pos_shift_015_noise_05,
