"""Forrester transfer learning benchmark with noise level 1.0 source.
...
def forrester_noise_1(settings: ConvergenceBenchmarkSettings) -> pd.DataFrame:
    """Forrester TL benchmark with noise level 1.0 source function.

    This benchmark evaluates transfer learning performance when the source task
    has moderate noise. Tests robustness of TL models to noise and their
    ability to extract underlying patterns despite significant noise corruption.
...
# Benchmark instance
forrester_noise_1_benchmark = ConvergenceBenchmark(
    function=forrester_noise_1,
